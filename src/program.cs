...
public class ServerConfig() {
    ...
    public static ServerConfig Make(IConfigurationRoot config) {
...
class Program {
    ...
    private static readonly int exitCode = 0;
    ...
    static void Start(string[] args) {
        ...
        try {
...
#endif
            var server = ServerConfig.Make(config);
            ...
            void sighup(int signalNumber) {
                config.Reload();
                Reload(config);
            }

            static void sigexit(int signalNumber) {
